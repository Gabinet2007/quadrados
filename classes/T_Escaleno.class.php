...
class Escaleno extends Triangulo
{
    ...
    public static function listar($tipobusca = 0, $busca = ""): array
    {
        ...
        while ($forma = $comando->fetch(PDO::FETCH_ASSOC)) {
            ...
            if($forma['formato'] == 'esca'){
            $triangulo = new Escaleno($forma['idTriangulo'], $forma['lado1'], $forma['lado2'], $forma['lado3'], $forma['cor'], $forma['imagem'], $medida, $forma['formato']);
        ...
        <a href='index.php?idTriangulo=" . $this->getId() . "'>
         <div style='position: relative; display: inline-block;'>
            <div style='
                width: 0;
                height: 0;
                border-left: " . $lado1 . $this->getIdMedida()->getNome(). " solid transparent;
                border-right: " . $lado2 . $this->getIdMedida()->getNome(). " solid transparent;
                border-bottom: " . $base . $this->getIdMedida()->getNome(). " solid " . $this->getCor() . ";
            ...
            <div style='
                    ...
                    width: " . (max($lado1, $lado2)*2) . $this->getIdMedida()->getNome() . ";
                    height: " . $base . $this->getLado3() . $this->getIdMedida()->getNome() . ";
                    background-image: url(" . '"' . $this->getImagem() . '"' . ");
                    background-size: cover;
                    background-repeat: no-repeat;
                    background-position: center;
