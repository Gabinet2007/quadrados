...
class Isoceles extends Triangulo
{
    ...
    public static function listar($tipobusca = 0, $busca = ""): array
    {
        ...
        while ($forma = $comando->fetch(PDO::FETCH_ASSOC)) {
            ...
            if ($forma['formato'] == 'iso') {
                $triangulo = new Isoceles($forma['idTriangulo'], $forma['lado1'], $forma['lado2'], $forma['lado3'], $forma['cor'], $forma['imagem'], $medida, $forma['formato']);
        ...
        <a href='index.php?idTriangulo=" . $this->getId() . "'>
            <div style='position: relative; display: inline-block;'>
                <div style='
                    width: 0;
                    height: 0;
                    border-left: " . $lado .$this->getIdMedida()->getNome(). " solid transparent;
                    border-right: " . $lado . $this->getIdMedida()->getNome()." solid transparent;
                ...
                '>
                    <div style='
                        ...
                        width: " . (2 * $lado) . $this->getIdMedida()->getNome().";
                        height: " . $base . $this->getIdMedida()->getNome().";
